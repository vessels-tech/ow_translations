...
export declare type Language = 'dutch' | 'english' | 'hindi' | 'gujarati' | 'test' | 'spanish' | 'french';
export declare type Region = 'australia' | 'india' | 'netherlands' | 'united states' | 'uppercase' | 'france' | 'spain';
...
export declare type TranslationOverrideFile = GGMNTranslationOverrideFile | MyWellTranslationOverrideFile;
export declare type GGMNTranslationOverrideFile = {

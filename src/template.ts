...
export function fileForOverrides(translationOrg: string, translationEnum: TranslationEnum, translations: { [index: string]: [string, TranslationRowType] }): string {
...
const ${translationOrg}_${translationEnum}: TranslationOverrideFile = {
  org: TranslationOrg.${translationOrg},
  overrides: {${getTemplateStrings(translations)}
  }
}

export {${translationOrg}_${translationEnum}};
`

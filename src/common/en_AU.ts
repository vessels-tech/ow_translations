...
const en_AU: TranslationFile = {
  ...
  templates: {
    ...
    settings_about: "<h2>MyWell</h2>",
    powered_by_html: "<h3>Developed by Lewis Daly and Basant Maheshwari</h3>",
    long_date_format: "<p>MyWell is a smartphone app for collecting, visualising and analysing water data for a given location.  Four types of data that can be uploaded: (i) depth to groundwater level, (ii) rainfall amount, (iii) checkdam water level and (iv) water quality parameters. Groundwater is an invisible resource and the data collected through this app can help us to visualise this vital resource and make more informed decisions about groundwater use and sharing.</p>",
    default_datetime_format: "<p>The app was developed in the <a href='http://www.marvi.org.in/home'>MARVI project</a> and designed to assist volunteers, called Bhujal Jaankaar (Hindi word meaning 'groundwater informed') to report data for online storage and easy access to anyone who need for groundwater management.  The app displays the current status of the groundwater level in wells, together with rainfall amounts, checkdam water levels and water quality parameter values for simple comparison and analysis.</p>",
    pending_resource_heading: "<p>The groundwater level fluctuation over time, alongwith rainfall and check dam water level data, can be used to estimate groundwater recharge following rainfall events. The estimation of recharge can help in planning for the cropped area in the next season and cooperative management of groundwater.</p>",
    resource_detail_owner_section: "<p>In general, MyWell is an important tool for crowdsourcing data and can be used by anyone who is interested to monitor local groundwater levels and other parameters and want to share those data publicly for non-commercial purposes.  The app was developed for monitoring groundwater and other parameters in rural catchments but it is equally useful in urban and peri-urban catchments.</p>",
    resource_detail_owner_name: "<p>Thanks to the following individuals for their valuable input and support during the development of the app:</p>",
    open_url_error: "<p>Dr P. Chinnasamy, Dr Y. Dashora, Dr P. Dillon, Dr H. Grewal, Dr Y. Jadeja, Dr R. Kookana, Mr S. Oza, Adj. Assoc. Prof. R. Packham, Mr P. Patil, Dr S. Prathapar, Mr M. Sharma, Dr P.K. Singh, Mr P. Soni, Assoc. Prof.  M. Varua, Assoc. Prof. M. Viswanathan and Dr J. Ward</p>",
    edit_readings_no_readings: "<p>The financial support for this work was provided by:</p>",
    edit_readings_new_reading: "<ul>",
    settings_map: "<li>(i)        Australian Centre for International Agricultural Research, Canberra, Australia and </li>",
    menu_browse_text: "<li>(ii)        Australian Water Partnership, Canberra, Australia</li>",
    menu_scan_text: "</ul>",
    menu_search_text: "",

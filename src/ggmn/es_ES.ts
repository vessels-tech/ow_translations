...
const ggmn_es_ES: TranslationOverrideFile = {
  ...
  overrides: {
    ...
    about_html: "<p>La Red Global de Monitoreo de Aguas Subterráneas, o GGMN por sus siglas en inglés, es una red de redes participativa,creada para mejorar la accesibilidad a la información obtenida mediante el monitoreo de este recurso, y así, mejorarnuestro conocimiento sobre el estado de las aguas subterráneas a nivel global. GGMN es un programa de la UNESCO,implementado por el Centro Internacional de Evaluación de Recursos de Agua Subterránea (IGRAC por sus siglas eninglés) y apoyado por socios globales y regionales.</p></br><strong>El Portal GGMN</strong></br><p>El portal GGMN (<a href='https://ggmn.un-igrac.org/'>https://ggmn.un-igrac.org/</a>) es una herramienta para elanálisis espacial y temporal de los datos de monitoreo y puede configurarse para su propia organización y/o proyectos.Los datos se pueden configurar para que sean privados (solo accesibles para usuarios autorizados) o públicos.</p></br><strong>GGMN y MyWell</strong></br><p>La aplicación GGMN está impulsada por MyWell, que es una app para smartphones y SMS que fue desarrollada en el marcodel proyecto MARVI<a href='https://www.westernsydney.edu.au/marvi/managed_aquifer_recharge_through_village-level_intervention'>(Gestiónde la recarga de acuíferos y uso sostenido de aguas subterráneas mediante intervenciones a nivel dealdea)</a>financiado por el Centro Australiano para la Investigación Agrícola Internacional (ACIAR). En MARVI,MyWell asiste a los 'voluntarios informados sobre el agua subterránea', o Bhujal Jankaars (BJ), en el monitoreo de losniveles piezométricos, precipitaciones, el nivel de agua en pequeñas represas, y la calidad del agua en lascomunidades rurales en India. Más información sobre MyWell y MARVI en:<ahref='http://www.marvi.org.in/home'>marvi.org.in</a></p></br><strong>¡Únete a la red!</strong></br><p>Si desea formar parte del programa GGMN y hacer uso del portal web junto con la aplicación, contáctenos a <ahref='mailto:info@un-igrac.org'>info@un-igrac.org</a> para obtener más información, o visite nuestro sitio webhttps://www.un-igrac.org/. De lo contrario, empiece a usar la aplicación libremente para almacenar datos piezométricosde agua subterránea en su teléfono.</p>",

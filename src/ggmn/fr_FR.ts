...
const ggmn_fr_FR: TranslationOverrideFile = {
  ...
  overrides: {
    ...
    about_html: "<p>Le GGMN (pour « Global Groundwater Monitoring Network », autrement dit le Réseau Mondial de Suivi des EauxSouterraines) est un programme qui vise à approfondir nos connaissances sur l’état des eaux souterraines à travers lemonde en améliorant la qualité et l'accessibilité des informations de suivi des eaux souterraines. Le GGMN repose surl’échange de données et d’expériences entre organisations en charge du suivi des eaux souterraines. Le GGMN est unprogramme de l'UNESCO mis en œuvre par IGRAC (Centre International d'Evaluation des Ressources en Eaux Souterraines)et soutenu par de nombreux partenaires mondiaux et régionaux.</p></br><strong>Portail GGMN</strong></br><p>Le portail internet du GGMN (<a href='https://ggmn.un-igrac.org/'>https://ggmn.un-igrac.org/</a>) facilite l’échangeet l'analyse spatiotemporelle des données de suivi des eaux souterraines. Les organisations qui y contribuent peuventpartager leurs données publiquement ou avec un nombre restreint d’utilisateurs. Le portail du GGMN est aussiaccessible via une application pour téléphones intelligents.</p></br><strong>GGMN et MyWell</strong></br><p> L'application du GGMN est basée sur MyWell, une application pour smartphone et SMS développée dans le cadre duprojet MARVI, <a href='https://www.westernsydney.edu.au/marvi/managed_aquifer_recharge_through_village-level_intervention'>(ManagedAquifer Recharge and Sustaining Groundwater Use through Village-level Intervention)</a> financé par le CentreAustralien pour la Recherche Internationale en Agriculture (ACIAR). MARVI mise sur l’implication des villageois afind’implémenter des solutions de recharge artificielle des aquifères et de gérer durablement les eaux souterraines dansles zones rurales de l’Inde. L’application MyWell assiste les villageois qui, sur base volontaire, opèrent le suivides niveaux piézométriques, des précipitations, des barrages et de la qualité de l’eau. Pour plus d'informations surMyWell et MARVI, visitez <a href='http://www.marvi.org.in/home'></a>.</p></br><strong>Rejoignez le réseau!</strong></br><p>Si vous souhaitez faire partie du GGMN et utiliser son portail, veuillez nous contacter via <a  href='mailto:info@un-igrac.org'>info@un-igrac.org</a>. L'application est accessible à tous, seules certainesfonctionnalités sont réservées aux membres du GGMN. Pour plus d’informations, visitez notre <a  href='https://www.un-igrac.org/ggmn'>site</a> internet.</p>",
